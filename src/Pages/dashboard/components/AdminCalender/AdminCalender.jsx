...
const AdminCalender = ({calendars, disablebooked, type, setlistNum}) => {
    const dispatch = useDispatch();

    const {status, apartmentInfo: {booked_dates, temp_booked_dates}} = useSelector(state => state.adminDashboard);
    ...
    React.useEffect(() => {
        setlistNum(listDate.length)
    }, [listDate.length, setlistNum])
