    ...
    return (
        <>
            <div style={{marginTop: 'max(2vw, 1.5rem)'}}>
                <InputSelect style={{paddingLeft: '10px'}} name="identification"  disabled={proceess === 'failed'}  value={dropdown.identification} dropdown={dropdown} setDropdown={setDropdown} options={id} label="Mode of Identifcation" defaultV="Choose Identification" />
            </div>
            <div style={{marginTop: 'max(2vw, 1.5rem)'}}>
