...
const Identification = ({formdata, setFormData, dropdown, setDropdown, id, FocusID, error}) => {
    return (
        <>
            ...
            <div style={{marginTop: 'max(2vw, .1rem)'}}>
                <Input type="number" label="ID Number" Focus={FocusID} error={!error} placeholder="1254 5577 7844 5987" name="idnumber" Icon={Identity} value={formdata.idnumber} formdata={formdata} handleChange={(e) => setFormData({...formdata, idnumber: e.target.value})}/>
            </div>  
        </>
    )
}
